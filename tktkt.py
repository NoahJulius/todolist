...
aufgabe_eingabe.insert(0, 'enter task')
...
aufgabe_dazu_btn = tk.Button(button_frame, text='add task', font=('Times', 14),
                             bg='green', fg='green', padx=20, pady=10, command=aufgabe_dazu)
aufgabe_dazu_btn.pack(fill=tk.BOTH, expand=True, side=tk.LEFT)

aufgabe_weg_btn = tk.Button(button_frame, text='task clear', font=('Times', 14),
                             bg='red', fg='red', padx=20, pady=10, command=aufgabe_weg)
